...
const DialogHeader = (props: ComponentProps<"div">) => {
  ...
  return (
    <div data-slot="dialog-header" class={cn("z-dialog-header flex flex-col", local.class)} {...others} />
  );
};
...
const DialogTitle = <T extends ValidComponent = "h2">(props: DialogTitleProps<T>) => {
  ...
  return (
    <DialogPrimitive.Title data-slot="dialog-title" class={cn("z-dialog-title", local.class)} {...others} />
  );
};
