...
const SheetHeader = (props: ComponentProps<"div">) => {
  ...
  return (
    <div data-slot="sheet-header" class={cn("z-sheet-header flex flex-col", local.class)} {...others} />
  );
};
...
const SheetTitle = <T extends ValidComponent = "h2">(props: SheetTitleProps<T>) => {
  ...
  return (
    <SheetPrimitive.Title data-slot="sheet-title" class={cn("z-sheet-title", local.class)} {...others} />
  );
};
